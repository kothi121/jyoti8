...
$jscomp.polyfill = function(b, h, f, p) {
    if (h) {
        ...
        p = f[b];
        h = h(p);
        h != p && null != h && $jscomp.defineProperty(f, b, {
            configurable: !0,
            writable: !0,
            value: h
        })
...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, f, p) {
        ...
        if ("function" == typeof n) {
            b = n.call(b);
            for (var u = 0; !(n = b.next()).done;) h.push(f.call(p, n.value, u++))
        } else
...
$jscomp.checkStringArgs = function(b, h, f) {
    if (null == b) throw new TypeError("The 'this' value for String.prototype." + f + " must not be null or undefined");
    if (h instanceof RegExp) throw new TypeError("First argument to String.prototype." + f + " must not be a regular expression");
    return b + ""
};
...
$jscomp.polyfill("String.prototype.includes", function(b) {
    return b ? b : function(b, f) {
        return -1 !== $jscomp.checkStringArgs(this, b, "includes").indexOf(b, f || 0)
    }
}, "es6", "es3");
(function() {
    function b(a, c) {
    ...
    function E(a) {
        ...
        a.querySelectorAll(".carousel-item").forEach(function(a) {
            for (var c = a, b = 1; b < e; b++) {
                ...
                if (d = c) {
                    var f = 0;
                    do f++; while (d = d.previousElementSibling);
                    d = f
                } else d = -1;
    ...
    function F(a) {
        ...
        if (b) {
            ...
            for (var d = 0; d < b.length; d++) c.push('"' + b[d].getAttribute("stop-color") + '"');
            c = '"lineargradient": [' + c + "],";
    ...
    function G(a, c) {
        if (a.classList.contains("circle-progress-section") && c.includes("progress") && "progressCount" != c)
            if (c.includes("Color")) a.querySelectorAll(".pie_progress").forEach(function(c) {
    ...
    var g, m, v = "function" == typeof jQuery;
    v && (g = jQuery);
    ...
    var H = function() {
        ...
        var e = parseInt(window.innerHeight / 2, 10),
            d = parseInt((window.getComputedStyle ? getComputedStyle(a,
    ...
    k(function() {
        ...
        function e(a) {
            b(a, "[data-bg-video]").forEach(function(a) {
                ...
                if (b) {
                    ...
                    else if (m) e.style.backgroundImage = 'url("images/video-placeholder.jpg")', e.style.display = "block";
                    else if (!m) {
        ...
        if (v) g(document).on("add.cards changeParameter.cards", function(c) {
        ...
        window.addEventListener("scroll", function() {
            ...
            if (t) {
                ...
                b ? c != t.fixed && (k ? (t.fixed =
                    c, t.elm.classList.toggle("is-fixed")) : l = setTimeout(function() {
                    t.fixed = c;
                    t.elm.classList.toggle("is-fixed")
                }, 40)) : (t.fixed = !1, t.elm.classList.remove("is-fixed"))
            }
        });
        if (v) g(document).on("add.cards delete.cards", function(a) {
            d && clearTimeout(d);
            d = setTimeout(function() {
                t && (t.fixed = !1, t.elm.classList.remove("is-fixed"));
                var a = document.querySelector(".mbr-fixed-top");
                a && (t = {
                    breakPoint: h(a).top + 3 * f(a),
                    fixed: !1,
                    elm: a
        ...
        if (v) g(document).on("add.cards", function(a) {
                    ...
                    do
                        if (b.hash) {
                            ...
                            document.querySelectorAll(c ? "body" : b.hash).forEach(function(c) {
                                ...
                                d = "#bottom" == b.hash ? f(c) - window.innerHeight : h(c).top - (d ? 60 : 0);
    ...
    if (!m) {
        if (v && g.fn.socialLikes) g(document).on("add.cards", function(a) {
        ...
        k(function() {
            if (!x() && document.querySelectorAll("input[name=animation]").length) {
                var a = function() {
                        ...
                        d.forEach(function(d) {
                            var l = d.offsetHeight,
                                f = e(d);
                            (f + l >= a && f - 50 <= c || b(d)) && d.classList.contains("hidden") && (d.classList.remove("hidden"), d.classList.add("animate__fadeInUp"), d.classList.add("animate__delay-1s"), d.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                                d.classList.remove("animate__animated animate__delay-1s animate__fadeInUp")
                            }, {
                                once: !0
                            }))
                        })
                ...
                var d = Array.from(document.querySelectorAll("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info"));
    ...
    k(function() {
        if (document.querySelectorAll(".mbr-arrow-up").length) {
            ...
            window.addEventListener("scroll", function() {
                (document.documentElement.scrollTop || document.body.scrollTop) > Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight,
                    document.documentElement.offsetHeight, document.body.clientHeight, document.documentElement.clientHeight) / 2 - document.documentElement.clientHeight / 2 || window.scrollY > window.innerHeight ? u(a) : n(a)
            });
    ...
    document.querySelectorAll("nav.navbar").length && (w = f(document.querySelector("nav.navbar")), document.querySelector(".mbr-after-navbar.mbr-fullscreen") && (document.querySelector(".mbr-after-navbar.mbr-fullscreen").style.paddingTop = w + "px"));
    if (!m && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) g(document).on("add.cards", function(a) {
        var b = a.target;
        b.classList.contains("mbr-fullscreen") && (a = function() {
            b.style.height = "auto";
            b.offsetHeight <=
                window.innerHeight && (b.style.height = "1px")
        ...
        if (!m) {
            var a = function(a) {
                ...
                b = function(b) {
                    ...
                    if (e) {
                        if (-1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*"), -1 !== e.indexOf("vimeo")) {
                    ...
                    k.addEventListener("click", function(b) {
                        "VIDEO" !== b.target.tagName && (e ? (-1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), -1 !== e.indexOf("vimeo") && f.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(), k.style.display = "none", k.removeEventListener("click", a), h.style.zIndex = "0")
                    })
                };
            document.querySelectorAll(".modalWindow-video > iframe").forEach(function(a) {
                ...
                if (b) {
                    ...
                    var c = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(shorts\/|video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/);
                    if (-1 !== b.indexOf("youtu")) a.setAttribute("src", "https://youtube.com/embed/" + c[6] + "?rel=0&enablejsapi=1");
                    else if (-1 !== b.indexOf("vimeo")) a.setAttribute("src", "https://player.vimeo.com/video/" +
                        c[6] + "?autoplay=0&loop=0");
    ...
    m || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function(a) {
        ...
        })), "undefined" === typeof window.initPopupBtnPlugin && 0 != document.body.querySelectorAll("section.popup-btn-cards").length &&
        (window.initPopupBtnPlugin = !0, document.querySelectorAll("section.popup-btn-cards .card-wrapper").forEach(function(a) {
            ...
            a.addEventListener("click", function() {
                var b = a.closest(".accordionStyles").getAttribute("id"),
                    ...
                    d = a.querySelector("span.sign") ? a.querySelector("span.sign") : a.querySelector("span.mbr-iconfont");
                !e.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ? (d.classList.remove("mbri-arrow-up"), d.classList.add("mbri-arrow-down")) : (d.classList.remove("mbri-arrow-down"), d.classList.add("mbri-arrow-up")), -1 != b.indexOf("accordion") && (b = a.closest(".accordionStyles"), Array.from(b.children).filter(function(a) {
    ...
    if (m && v) g(document).on("add.cards", function(a) {
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com/how-to/music.html">How to Create music Website</a> Mobirise v5.9.0 <a href="https://mobirise.com/how-to/kids.html">How to Create Website for Kids</a>';
